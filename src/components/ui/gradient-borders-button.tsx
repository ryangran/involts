...
export default function GradientBordersButton({
  ...
  return (
    <button
      className={cn(
        'group relative inline-block cursor-pointer rounded-full border-none bg-black p-0.5 text-xs leading-6 font-semibold text-foreground no-underline outline-none focus-visible:ring-1 focus-visible:ring-orange-400',
        className
      )}
      type='button'
      {...props}
    >
      ...
      <div className='relative z-10 flex h-8 items-center space-x-2 rounded-full bg-black px-4 text-foreground/90 ring-2 ring-white/10'>
