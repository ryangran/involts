...
const footerLinks = {
  produtos: [
    { label: 'Nobreaks', href: '#' },
    { label: 'Estabilizadores', href: '#' },
    { label: 'Filtros de Linha', href: '#' },
    { label: 'Autotransformadores', href: '#' },
    { label: 'Aterramento', href: '#' },
  ],
  empresa: [
...
export const Footer = () => {
  return (
    <footer id="contato" className="relative bg-muted/50 border-t border-border overflow-hidden">
      {/* Background */}
          ...
          <AnimatedSection delay={0.3}>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-foreground/60">(11) 0000-0000</p>
